...
public class Main {
    ...
    public static String toRoman(int arabian) {
        ...
        Map<Integer, String> dictionary = new TreeMap<>(Collections.reverseOrder()); { dictionary.put(100,"C"); dictionary.put(90,"XC"); dictionary.put(50,"L"); dictionary.put(40,"XL"); dictionary.put(10,"X"); dictionary.put(9,"IX"); dictionary.put(5,"V"); dictionary.put(4,"IV"); dictionary.put(1,"I");}
